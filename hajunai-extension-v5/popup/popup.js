...
// 저장 함수: 외부 AI 대화 → 하준아이 master Message
...
async function loadHajunSpaces() {
  ...
  yardSelect.innerHTML = '<option value="">마당 선택</option>' + hajunSpaces
    .map(y => `<option value="${y.key}">${y.name}</option>`).join('');
